...
public class TetrisBrainTest {
    ...
    public void testMoveValidity() {
        ...
        game.startGame();
        Assertions.assertFalse(FinalBrain.outOfBounds(game.board, game.board.getCurrentPiecePosition().x,
    ...
    public void testDecision() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field privateField3 = FinalBrain.class.getDeclaredField("options");
