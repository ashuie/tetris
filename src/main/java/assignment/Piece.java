...
public interface Piece {
    ...
    enum PieceType {
        ...
        private final Point[] spawnBody;

        // The color of this tetromino.
        private final Color color;

        // The width and height of the SRS bounding box.
        private final int boundingBoxWidth, boundingBoxHeight;
        ...
        /**
         * Return the body points of the tetromino in its spawn state. These
     ...
     * tetrominoes, per the wall kick specification. This list is indexed by the SOURCE rotation index (i.e. if your
     ...
     * wall kick specifications. This list is indexed by the SOURCE rotation index (i.e. if your rotation is O -> R, the
    ...
    /**
     * Return the rotation index of this piece, which is the index of its current rotation state.
     ...
     * 3 clockwise produces rotation index 0, and rotating index 0 counterclockwise produces rotation
     * index 3.
     */
